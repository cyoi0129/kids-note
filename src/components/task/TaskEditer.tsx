...
const TaskEditorComponent: FC<Props> = (props) => {
  ...
  const { taskData, closeEditor } = props;
  ...
  } = useForm<Task>({ mode: "onChange", defaultValues: taskData });
  if (!taskData.Id) return;
  const { error, isMutating, trigger } = UpdateTask(taskData.Id);
                ...
                return (
                  <label key={value}>
                    <input
                      ...
                      value={value}
                      defaultChecked={taskData.Types.includes(value)}
                    />
                    {label}
                  </label>
                );
                ...
                return (
                  <label key={value}>
                    <input
                      ...
                      value={value}
                      defaultChecked={taskData.Kid === value}
                    />
                    {label}
                  </label>
                );
                ...
                return (
                  <label key={value}>
                    <input
                      ...
                      value={value}
                      defaultChecked={taskData.UserId === value}
                    />
                    {label}
                  </label>
                );
